...
#   dependencies, unresolved_imports
# Output schema (per function):
#   name, tag, line_start, line_end, docstring, parameters, return_annotation,
#   columns{read,written,new,all}, joins, aggregations, filters,
#   window_functions, operations{...}, flags{...}, transformation_types,
#   pyspark{pattern,risk,comment,warnings}
# ===========================================================================
...
# ── PySpark functions.* / Column-method vocabularies ───────────────────────

# Functions that wrap a plain string into a Column reference: F.col("x"),
# col("x"), F.column("x").  Their string arg IS a column name.
